        ...
        <form onSubmit={handleSubmit} className="holo-card p-8 space-y-6">
          ...
          <div>
            ...
            {coverPreview && (
              <img
                src={coverPreview}
                alt="封面预览"
                className="mt-4 w-full max-h-60 object-cover rounded-xl border border-white/[0.08]"
              />
            )}
          </div>
          ...
          <div className="flex space-x-4">
            <button
              type="submit"
              disabled={isLoading}
              className="flex-1 bg-gradient-to-r from-[#00f0ff] to-[#00c8ff] text-[#050510] font-bold py-3 px-6 rounded-xl shadow-sm hover:shadow-[0_0_25px_rgba(0,240,255,0.3)] hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50"
            >
              {isLoading ? '创建中...' : '创建项目'}
            </button>
            <button
